...
并在读取**任何**战利品表时把它写进对应条目（`BoxLootTable#applyItemQuality`），
于是 `BaseWeight × (1 + Quality × factor)` 才真正生效：宝箱越高级，好东西出现得越多。

* **绝大多数物品固定为 0**，只有一小部分被赋值。内置分档（约 110 个物品）：

| Quality | 物品示例 |
|---|---|
| 10 | 龙蛋、下界之星、附魔金苹果、鞘翅、龙首、信标 |
| 9 | 下界合金锭、下界合金升级锻造模板、不死图腾、海洋之心、凋灵骷髅头颅、Pigstep |
| 8 | 远古残骸 / 下界合金碎片、三叉戟、潮涌核心、回响碎片、追溯指针、潜影壳、附魔书 |
| 7 | 全套下界合金装备 |
| 6 | 钻石及钻石装备 / 钻石马铠、金苹果、鹦鹉螺壳、末影水晶、命名牌 |
| 5 | 绿宝石块、金马铠、附魔之瓶、各种唱片、鞍 |
| 4 | 绿宝石、金块 / 铁块、恶魂之泪、铁马铠、烈焰棒、末影之眼、哭泣的黑曜石、紫水晶… |
| 3 | 金锭、铁 / 金装备、书、黑曜石、末影珍珠、TNT、萤石、蜂巢盖… |
| 2 | 铁锭、青金石、红石块、下界石英、幻翼膜、黏液球、盾牌… |
| 1 | 煤炭块、金粒、箭、面包、皮革、火药、燧石… |

* 存储在 `config/randombox/item_quality.json`（首次启动自动生成，只写非 0 的项），可任意增删改。
* 也可以在游戏里改：
  * `/RandomBox Quality <物品ID>` 查询；
  * `/RandomBox Quality <物品ID> <0-100>` 设置（写回 json，设 0 表示移除）。
