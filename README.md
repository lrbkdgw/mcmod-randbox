...
* **绝大多数物品固定为 0**，取值范围 **0 ~ 4**，内置清单共 **139 个**物品：

| Quality | 物品 |
|---|---|
| 4 | 龙蛋、下界之星、附魔金苹果、鞘翅、信标 |
| 3 | 下界合金锭、下界合金块、不死图腾、海洋之心、末影龙首、钻石块、Pigstep 唱片、嗅探兽蛋 |
| 2 | 凋灵骷髅头颅、远古残骸、下界合金碎片 / 升级模板 / 全套下界合金装备、潮涌核心、钻石、全套钻石装备、绿宝石、绿宝石块、潜影壳、回响碎片、追溯指针、末影水晶、龙息、鹦鹉螺壳、骷髅 / 僵尸 / 苦力怕头颅、海绵 / 湿海绵、磁石、金块、命名牌 |
| 1 | 附魔书、三叉戟、金苹果、附魔之瓶、鞍、钟、海晶灯、末影之眼、末影珍珠、烈焰棒、恶魂之泪、紫水晶碎片、金胡萝卜、闪烁的西瓜片、望远镜、弩、迷之炖菜、哭泣的黑曜石、镶金黑石、铁块、青金石块、黑曜石、萤石、TNT、金锭、蛋糕、附魔台、锁链装备 ×4、马铠 ×4、唱片 ×14 + 唱片碎片、盔甲纹饰锻造模板 ×16、陶片 ×20 |
