...
* **绝大多数物品固定为 0**，只有一小部分被赋值，取值范围 **0 ~ 4**：

| Quality | 物品 |
|---|---|
| 4 | 龙蛋、下界之星、附魔金苹果、鞘翅、信标 |
| 3 | 下界合金锭、不死图腾、海洋之心、末影龙首 |
| 2 | 凋灵骷髅头颅、远古残骸、潮涌核心、下界合金装备 / 碎片 / 升级模板、钻石、绿宝石、潜影壳、Pigstep、回响碎片、追溯指针 |
| 1 | 附魔书、三叉戟、金苹果、各种马铠、各种唱片（含碎片）、各类盔甲纹饰锻造模板 |
